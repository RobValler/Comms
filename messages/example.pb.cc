...
static void InitDefaultsscc_info_test_msg_example_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_test_msg_example_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_test_msg_example_2eproto}, {}};
...
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_example_2eproto_sccs[1] = {
  &scc_info_test_msg_example_2eproto.base,
};
...
test_msg::test_msg(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:test_msg)
}
...
template<> PROTOBUF_NOINLINE ::test_msg* Arena::CreateMaybeMessage< ::test_msg >(Arena* arena) {
  return Arena::CreateMessageInternal< ::test_msg >(arena);
}
